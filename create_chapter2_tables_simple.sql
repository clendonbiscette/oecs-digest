...
CREATE POLICY IF NOT EXISTS "Users can view staff age data" ON staff_age_distribution
...
CREATE POLICY IF NOT EXISTS "Users can view staff service data" ON staff_years_of_service
    FOR SELECT TO authenticated USING (true);
